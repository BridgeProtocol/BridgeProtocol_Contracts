...
contract  BRIDGENODE is StandardToken, SafePayloadChecker {
  uint256 public initialSupply = 18000* (10 ** uint256(decimals));
  string public constant name = "Bridge Protocol Node Token";
